...
alter table t_repository add column in_certified_scope boolean not null default false;
alter table t_container add column in_certified_scope boolean not null default false;

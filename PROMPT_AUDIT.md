...
1. 📚 Documentation & Architecture :
   ...
   - Registre des décisions d'architecture (ADR 0001 à 0013 dans docs/architecture/).
...
1. 📚 Documentation & Architecture:
   ...
   - Architectural Decision Records registry (ADR 0001 through 0013 in docs/architecture/).

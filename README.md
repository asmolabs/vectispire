...
- **Secret detection** (Gitleaks & Betterleaks): finds hardcoded API keys, tokens, and credentials in scanned repositories using dual-engine analysis with automatic deduplication.

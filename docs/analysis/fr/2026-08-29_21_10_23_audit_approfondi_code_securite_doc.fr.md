...
- [`ComplianceService:250`](../../../vectispire-java/vectispire-core/src/main/java/com/asmolabs/vectispire/core/compliance/ComplianceService.java) et `:379` — projetés en `MttrCalculator.ResolvedIssue(severity, firstSeenAt, resolvedAt)`

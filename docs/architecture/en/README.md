...
| [05 — Modularity as Spring Modulith sees it](05-modularity.md) | Which modules does Modulith detect today, what would its verification reject, and what does the next step change? |

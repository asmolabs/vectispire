...
| **04** | **Vue Infrastructure & Déploiement** | [`04_vue_infrastructure.md`](04_vue_infrastructure.md) | SGBD multi-dialectes (PostgreSQL, MySQL (SQLite for tests)), migrations Flyway, socket Docker, agents distants. |

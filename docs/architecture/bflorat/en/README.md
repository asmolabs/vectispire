...
| **04** | **Infrastructure & Deployment** | [`04_infrastructure_view.md`](04_infrastructure_view.md) | Multi-engine databases (PostgreSQL, MySQL (SQLite for tests)), Flyway migrations, Docker socket, remote agents. |

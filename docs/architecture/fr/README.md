...
| [05 — La modularité vue par Spring Modulith](05-modularity.md) | Quels modules Modulith détecte-t-il depuis que les domaines sont des modules, que rejette sa vérification — elle casse le build depuis l'étape 6 — et qu'a changé chaque étape ? |

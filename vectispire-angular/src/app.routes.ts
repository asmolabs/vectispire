...
export const appRoutes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'certified-scope', canActivate: [requires('governance-read')], loadComponent: () => import('./app/pages/certified-scope/certified-scope').then((m) => m.CertifiedScope) },
            { path: 'compliance-history', canActivate: [requires('governance-read')], loadComponent: () => import('./app/pages/compliance-history/compliance-history').then((m) => m.ComplianceHistoryPage) },

 ...
 */
export class CiblageDesAgents1786790000000 implements MigrationInterface {
    name = 'CiblageDesAgents1786790000000';

    public async up(queryRunner: QueryRunner): Promise<void> {
        for (const table of ['t_repository', 't_container', 't_scan']) {
            await queryRunner.query(`ALTER TABLE "${table}" ADD COLUMN "required_agent_label" VARCHAR(255)`);
        }

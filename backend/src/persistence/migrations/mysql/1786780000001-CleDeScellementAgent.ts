 ...
 */
export class CleDeScellementAgent1786780000001 implements MigrationInterface {
    name = 'CleDeScellementAgent1786780000001';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`t_agent\` ADD COLUMN \`sealing_public_key\` VARCHAR(255) NULL`);
    }

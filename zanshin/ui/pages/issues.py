    ...
    content = rx.vstack(
        ...
        rx.hstack(
            stat_card("À traiter", IssuesState.actionable_count, "circle-alert", "red",
                      alert=IssuesState.actionable_count > 0),
            stat_card("Ouverts", IssuesState.open_count, "folder-open"),
            stat_card("À examiner", IssuesState.under_review_count, "search"),
            stat_card("Résolus", IssuesState.resolved_count, "circle-check", "green",
                      alert=IssuesState.resolved_count > 0),
            width="100%",
            spacing="4",

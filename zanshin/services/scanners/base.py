...
class ScannerEngine(ABC):
    ...
    See décision 0001. The rest of the
    ...
    sidecar HTTP service on the same host, docs/architecture/01), and
    ...
    def scan_secrets(self, work_dir: str, sub_path: str = "") -> list:
        ...
        image scanning does not call this today (see docs/architecture/01).
        """
        raise NotImplementedError
